...
namespace TheSocialNetwork.WebApp.Controllers
{
    public class PostsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,PublishDateTime,Content,PhotoUrl,Review,Price,Rate")] Post post, HttpPostedFileBase binaryFile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> EditAsync([Bind(Include = "Id,PublishDateTime,Content,PhotoUrl,Review,Price,Rate")] Post post, HttpPostedFileBase binaryFile)
        {
            if (ModelState.IsValid)
            {
                if (binaryFile != null)
